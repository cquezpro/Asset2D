...
public class Asset2SD extends CordovaPlugin {
	...
	public String copyFile(String arg_assetFile, String arg_destinationFile) throws IOException {
		...
		String name = destination_file.getName();
		int pos = name.lastIndexOf(".");
		if (pos > 0) {
		    name = name.substring(0, pos + 4);//4 means length of "." + 3 extension(e.g. pdf)
		}
		...
		copyAssetFile(arg_assetFile, destination_file_path + "/"+name);
